...
public final class DefaultTokenManager: TokenManager {
    ...
    public static let shared = DefaultTokenManager()
    ...
    init(
        keychainStorage: KeychainStorage = KeychainStorageImpl.shared,
    ...
    public func updateAuthToken(accessToken: String, refreshToken: String) {
